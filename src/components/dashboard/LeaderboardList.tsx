                ...
                {items.map((entry, index) => {
                    ...
                    const linkContent = (
                        <motion.div
                            ...
                            className="relative bg-white/[0.02] border border-white/5 p-5 md:p-6 rounded-2xl flex items-center justify-between transition-all duration-300 hover:bg-white/[0.04] hover:border-white/10 overflow-hidden"
                        >
